...
if model_choice.startswith("General"):
    ...
    model, grad_model, CLASS_NAMES, preprocess_fn, mode_key = load_ntd_artifacts2()
    cam_model = None
...
if nav == "Upload & Predict":
    ...
    if up is not None:
        ...
        if mode_key == "ntd":
            # --- NTD guardrails: background gate ---
            ...
            # tighter thresholds for plain skin
            ...
            # predict then confidence/margin gate
